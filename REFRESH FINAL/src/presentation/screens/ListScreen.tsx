...
// ListScreen vive dentro de una pestaña (AdminTabParamList), pero necesita
// poder navegar a pantallas del stack raíz (Crear, Detalle) -> tipado
// compuesto (tab + stack padre).
type Props = CompositeScreenProps<
  BottomTabScreenProps<AdminTabParamList, 'SolicitudesTab'>,
  NativeStackScreenProps<AdminStackParamList>
>;

export default function ListScreen({ navigation }: Props) {
  const { solicitudes, servicios, cargando, error, refrescar } = useSolicitudes();
...
const styles = StyleSheet.create({
  ...
  errorBannerText: { color: COLORES.peligro, fontSize: 12.5, flex: 1, marginRight: 8 },
  errorBannerRetry: { color: COLORES.peligro, fontWeight: '700', fontSize: 12.5 },
