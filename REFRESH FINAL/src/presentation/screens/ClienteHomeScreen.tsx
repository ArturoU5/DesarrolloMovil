...
import type { ClienteStackParamList, ClienteTabParamList } from '../navigation/types';

type Props = CompositeScreenProps<
  BottomTabScreenProps<ClienteTabParamList, 'MisSolicitudesTab'>,
  NativeStackScreenProps<ClienteStackParamList>
>;
