    ...
    <TouchableOpacity style={styles.card} onPress={onPress} activeOpacity={0.8}>
      <View style={styles.headerRow}>
        ...
        <View style={styles.precioWrap}>
          <Text style={styles.precioTexto}>S/ {solicitud.precio.toFixed(2)}</Text>
          <Text style={styles.cantidadTexto}>{solicitud.cantidadPrendas} prenda(s)</Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  precioTexto: { fontSize: 14, fontWeight: '800', color: COLORES.primarioOscuro },
  cantidadTexto: { fontSize: 11, color: COLORES.textoSecundario, marginTop: 2 },
