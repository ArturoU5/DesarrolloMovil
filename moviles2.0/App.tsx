...
/** Stack interno de solicitudes para el rol ADMIN (vive dentro del tab "Solicitudes"). */
function AdminSolicitudesStack() {
  return (
    <AdminStack.Navigator initialRouteName="Listado" screenOptions={screenOptions}>
      <AdminStack.Screen name="Listado" component={ListScreen} options={{ headerShown: false }} />
...
/** Stack interno de solicitudes para el rol CLIENTE (vive dentro del tab "Mis solicitudes"). */
function ClienteSolicitudesStack() {
  return (
...
function AdminTabs() {
  return (
    ...
    >
      <AdminTab.Screen
        name="SolicitudesTab"
        component={AdminSolicitudesStack}
  ...
  return (
    ...
    >
      <ClienteTab.Screen
        ...
        component={ClienteSolicitudesStack}
...
function RootNavigator() {
  ...
  return auth.role === 'ADMIN' ? <AdminTabs /> : <ClienteTabs />;
}
